...
function AwesomeChart(canvasElementId){
    ...
    this.labelMargin = 10;
    this.dataValueMargin = 1;
    this.titleMargin = 10;
    this.yAxisLabelMargin = 1;
    ...
    this.barShadowBlur = 1;
    this.barShadowOffsetX = 1.0;
    this.barShadowOffsetY = 0.0;
    
    this.barHGap = 10;
    this.barVGap = 20;
    
    this.explosionOffset = 10;
    ...
    */
    ...
    this.drawVerticalBarChart = function(){
        ...
        var barWidth = (this.width - this.marginLeft
            - 150 - this.marginRight - (n-1) * this.barHGap) / n;
